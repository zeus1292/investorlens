export default function ExplanationPanel({ explanation, highlights, loading }) {
  return (
    <div className="rounded-xl bg-white border border-surface-200 p-4 shadow-sm">
      <h3 className="text-sm font-medium text-surface-600 mb-3">Analysis</h3>
      ...
      {loading && !explanation && (
        <div className="space-y-2 animate-pulse">
          ...
          <div className="h-3 bg-surface-200 rounded w-full" />
          <div className="h-3 bg-surface-200 rounded w-3/6" />
      ...
      {explanation && (
        <div className="space-y-3">
          <p className="text-sm text-surface-800 leading-relaxed whitespace-pre-line">{explanation}</p>
